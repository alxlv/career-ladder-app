  ...
  jobs: [
    {
      ...
      faculty: 'Automatisation, networks, IT',
      ...
      projects: [
        { title: 'WebTel', description: 'Software for remote monitoring and control of uninterruptible power supply and WEB-based invertors.', responsibilities: 'Problem definition and development of the application structure and algorithms' +
        ...
        { title: 'WebTel TFTP updater', description: 'Software for loading updates of a program via a TFTP application-level protocol.', responsibilities: 'development of the application structure and algorithms' +
      ...
      projects: [
        { title: 'Kzp', description: 'Software for control and monitoring of railway equipment with the help of the serial port interface.',
          responsibilities: '• development of the application structure and algorithms' +
          '• code writing in Microsoft Visual Studio .Net 2003' +
          '• refactoring code using GoF patterns' +
          '• WinForms, Unit testing, ADO .NET, Reflection, Generics' +
      ...
      projects: [
        { title: 'SMM', description: 'Application software for diagnostic and management the relay protection system.',
          responsibilities: '• development GUI module for digital filter',
          tags: [
        ...
        { title: 'TransConnect', description: 'Software for diagnostic, measurement of gas analysis hostboard through USB/TCP/Serial port interfaces.',
          responsibilities: '• development GUI and communication modules' +
      ...
      projects: [
        { title: 'Analytics Master', description: 'Software for optimizing hedge fund activities.',
          responsibilities: '• development GUI and business logic (MSSQL 2005)' +
          '• code writing in Visual Studio .NET 2008 TFS (Framework 2.0/3.5)' +
          '• Refactoring, GoF design patterns' +
          '• WinForms, Unit testing, Web service, WF, ADO .NET, XML processing, Serialization, Reflection, Generics, Remoting' +
          '• Scrum',
          tags: [
      ...
      projects: [
        { title: 'Raptor', description: 'It is a complete requirements solution for definition and collaboration. Enables authors to define requirements using rich text, UI mockups, use cases, business process, data, and roles. Uses rich simulation to visually communicate requirements to stakeholders in distributed or local organizations.',
          responsibilities: '• Working by SCRUM methology in the distributed team of 20 members' +
          ...
          '• Unit testing, EF, LINQ, XML processing, Serialization, Reflection, Generics',
          tags: [
      ...
      projects: [
        { title: 'SIMActivator', description: 'Software for automation of business processes for regional telecommunication companies.',
          responsibilities: '• managing team as technical leader within 2 developers working by SCRUM methology' +
          '• development GUI and business logic (MySQL 5.x)' +
          '• code writing in Visual Studio .NET 2008 Professional (Framework 3.5), C#' +
          '• GoF design patterns' +
          '• WPF/WinForms, Unit testing, Windows services, LINQ, XML processing, Serialization, Reflection, Generics' +
          '• AJAX, jQuery',
          tags: [
      ...
      projects: [
        { title: 'Perfect Vision Gallery', description: 'The tool helps non professionals to create video presentations easy and fast.',
          responsibilities: '• Create build box machine using VisualBuild Pro' +
      ...
      projects: [
        { title: 'Ultima ERP', description: '',
          ...
          title: 'Supplier exchnage', description: '',
          responsibilities: '',
          tags: [
